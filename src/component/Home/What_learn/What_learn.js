...
const What_learn = () => {
  ...
  <div className="card-body">
    ...
    <p className='text-1xl pt-5'>Use HDFS & Map Reduce for storing & analyzing data at scale.</p>
...
<div className="card   shadow-xl">
  <div className="card-body">
    ...
    <p className='text-1xl pt-5'>Consume streaming data using Spark Streaming, Flink, and Storm.</p>
...
<div className="card   shadow-xl">
  <div className="card-body">
    ...
    <p className='text-1xl pt-5'>Choose an appropriate data storage technology for your application</p>
...
<div className="card   shadow-xl">
  <div className="card-body">
    ...
    <p  className='text-1xl pt-5'>Analyze non-relational data using HBase, Cassandra, and MongoDB.</p>
